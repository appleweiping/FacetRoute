...
A push of a semantic-version tag such as `v0.18.0` invokes the release
...
gh attestation verify facetroute-0.18.0-py3-none-any.whl \
  --repo appleweiping/FacetRoute
```
